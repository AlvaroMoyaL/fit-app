...
- `Nutrición > Estado diario > Histórico` ahora permite ampliar los charts de `Calorías vs TDEE` y `Macros por día`: cada card es clicable y abre un diálogo responsive con una versión más grande del gráfico para análisis visual más cómodo, manteniendo el panel lateral de detalle por fecha intacto.
